...
async function deleteComment(animeTitle, commentId) {
  try {
    ...
    if (success) updateAnimeStats(animeTitle); // Atualiza as estatísticas em tempo real
...
async function editComment(animeTitle, commentId, newText, newRating) {
  try {
    ...
    if (result) updateAnimeStats(animeTitle); // Atualiza as estatísticas em tempo real
...
function updateCharCount(textarea, counterId) {
  ...
  if (counter) counter.textContent = `${textarea.value.length}/${MAX_COMMENT_LENGTH}`;
}
...
window.hasUserAlreadyCommented = hasUserAlreadyCommented;
window.saveComment = saveComment;
window.updateAnimeRating = updateAnimeRating;
window.deleteComment = deleteComment;
window.voteComment = voteComment;
window.getUserVote = getUserVote;
window.isUserAdmin = isUserAdmin;
window.editComment = editComment;
window.toggleEditMode = toggleEditMode;
window.updateEditRatingDisplay = updateEditRatingDisplay;
window.renderComment = renderComment;
window.updateCommentsList = updateCommentsList;
window.updateRatingDisplay = updateRatingDisplay;
window.updateRatingEmoji = updateRatingEmoji;
window.updateCharCount = updateCharCount;
window.MAX_COMMENT_LENGTH = MAX_COMMENT_LENGTH;
window.updateAnimeStats = updateAnimeStats;