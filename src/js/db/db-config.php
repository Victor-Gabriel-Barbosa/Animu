...
define('DB_PASS', '');              // Senha do banco de dados (substitua pela senha real em produção)
...
function setupDatabase() {
    ...
    if ($conn->query($sql) === FALSE) {
        die("Erro ao criar a tabela developers: " . $conn->error);
    }
...
// Descomente a linha abaixo para configurar o banco de dados pela primeira vez
// setupDatabase();
?>